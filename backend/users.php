					...
					<div class="col-md-12">
						<div class="widget box">
							<div class="widget-header">
								<h4><i class="icon-reorder"></i> รายชื่อผู้ใช้งาน</h4>
								...
								<table class="table table-striped table-bordered table-hover table-checkable table-tabletools datatable">
									...
									<tbody>
										<tr>
											...
											<td><img src="assets/img/demo/avatar-1.jpg"/></td>
											<td>John Doe</td>
											<td>username1</td>
											<td class="hidden-xs">19:00 17-11-2559</td>
											<td><span class="label label-success">Approved</span></td>
											<td>
												<a href="user.php"><button class="btn btn-info btn-sm"><i class="icon-cog"></i></button></a>
										...
										<tr>
											...
											<td><img src="assets/img/demo/avatar-2.jpg"/></td>
											<td>Micheal Bay</td>
											<td>username2</td>
											<td class="hidden-xs">19:00 17-11-2559</td>
											<td><span class="label label-success">Approved</span></td>
										...
										<tr>
											...
											<td><img src="assets/img/demo/avatar-3.jpg"/></td>
											<td>Dawin Stuart</td>
											<td>username3</td>
											<td class="hidden-xs">19:00 17-11-2559</td>
