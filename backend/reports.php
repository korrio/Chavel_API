			...
			<div class="container">
				...
				<div class="page-header">
					<div class="page-title">
						<h3>ส่วนจัดการเรื่องร้องเรียน</h3>
					...
					<div class="col-md-12">
						<div class="widget box">
							<div class="widget-header">
								<h4><i class="icon-reorder"></i> รายการแจ้งเรื่องร้องเรียน</h4>
								...
								<table class="table table-striped table-bordered table-hover table-checkable table-tabletools datatable">
									<thead>
										<tr>
											...
											<th class="hidden-xs">วันที่แจ้งเรื่อง</th>
											<th>จำนวนผู้แจ้ง</th>
											<th width="200"></th>
										</tr>
									</thead>
									<tbody>
										...
										<tr>
											...
											<td>รูปภาพไม่เหมาะสม, ใช้ภาษาที่ไม่เหมาะสมในบทความ</td>
											<td class="hidden-xs">19:00 17-11-2559</td>
											<td>15</td>
											<td>
												<a href="#"><button class="btn btn-info btn-sm"><i class="icon-cog"></i></button></a>
										...
										<tr>
											...
											<td>กล่าวถึงบุคคลอื่นในทางเสียหาย</td>
											<td class="hidden-xs">19:00 17-11-2559</td>
											<td>10</td>
											<td>
												<a href="#"><button class="btn btn-info btn-sm"><i class="icon-cog"></i></button></a>
