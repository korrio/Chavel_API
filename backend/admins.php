					...
					<div class="col-md-12">
						<div class="widget box">
							<div class="widget-header">
								<h4><i class="icon-reorder"></i> รายชื่อผู้ดูแลระบบ</h4>
								...
								<table class="table table-striped table-bordered table-hover table-checkable table-tabletools datatable">
									...
									<tbody>
										<tr>
											...
											<td>
												<a href="admin.php"><button class="btn btn-info btn-sm"><i class="icon-cog"></i></button></a>
